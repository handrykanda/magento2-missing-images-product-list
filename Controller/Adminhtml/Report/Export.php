...
use ThreeDegrees\MissingProductImagesReport\Model\ResourceModel\Product\CollectionFactory;
...
public function execute()
{
    ...
    $stream->unlock();
    $stream->close();
    return $this->fileFactory->create('threedegrees_missing_product_images_report.csv', [
        'type' => 'filename',
        'value' => $file,
